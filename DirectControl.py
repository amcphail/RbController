...
class AnalogEntry(QtWidgets.QWidget):
    ...
    def __init__(self,channel,analogLine, parent = None):
        ...
        self.cbEnable = QtWidgets.QCheckBox(self)
        self.cbEnable.setGeometry(QtCore.QRect(250,0,20,20))
        self.cbEnable.setCheckState(False)
        self.cbEnable.setObjectName("cbEnable")

        self.sbValue.valueChanged.connect(self.changeValue)
        self.cbEnable.stateChanged.connect(self.enableEdit)
...
class NetworkEntry(QtWidgets.QWidget):
    ...
    def __init__(self,channel,networkLine, parent = None):
        ...
        self.wNetworkDDS.setGeometry(QtCore.QRect(0, 20, 450,80))
...
class DirectControl(QtWidgets.QWidget):
    def __init__(self,mainWindow,parent = None):
        ...
        for ii in range(daq.network_outputs):
            ...
            self.networkLines[ii].setGeometry(QtCore.QRect(self.column*350+20, self.cursor, 450, 100))
